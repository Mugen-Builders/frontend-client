...
// const baseWallet = ethers.HDNodeWallet.fromMnemonic(mnemonicObj);
// const derivedWallet = baseWallet.derivePath(`m/44'/60'/0'/0/1`);
// const signer = derivedWallet.connect(provider as ethers.AbstractProvider)
...
//       ethers.hexlify(ethers.toUtf8Bytes(input.notices![i].payload))
//     );  
//   }  
...
//       ethers.hexlify(ethers.toUtf8Bytes(input.reports![i].payload))
//     );  
//   }
// }
